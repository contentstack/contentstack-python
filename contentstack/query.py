...
class Query:
    ...
    def __init__(self, content_type_uid):
        ...
        """
        :param content_type_uid: the unique ID of the content type
        of which you wish to retrieve the details. The uid
        is generated based on the title of the content type and it is unique across a stack
        :type content_type_uid: URI Parameters
    ...
    def content_type(self, content_type_id):
        ...
        >>> query = query.content_type = 'your_product'
        ==============================
        """
    ...
    def remove_header(self, key):
        ...
        >>> query = query.remove_header('header_something')
        ==============================
        """
    ...
    def less_than_or_equal_to(self, key, value):
        ...
        :param key: The key to be constrained
        :param value: value The value that must be equalled.
    ...
    def not_exists(self, key):
        ...
        ==============================
        In the Product content type, we have a field named Price in USD. Now, you want to retrieve all the entries in
        the content type in which the field does not exists
    ...
    def except_field_uid(self, *field_uid):
        ...
        >>> query.except_field_uid('price_in_usd')
        >>> result = query.find()
        ==============================
        """
    ...
    def only_with_reference_uid(self, reference_field_uid, *field_uid):
        ...
        >>> query.only_with_reference_uid('price_in_usd', 'field_uid 1', 'field_uid 2')
        >>> result = query.find()
        ==============================
        """
    ...
    def find(self):
        ...
        ==============================
        [Example]: Chain any query/queries
        query.where("color")
        query.where_in("brand")
        query.search("some_key")
        .
        .
        .
        result = query.find()
